...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ScanHistory", function() { return ScanHistory; });
class ScanHistory {
}
...
/* harmony import */ var _ScanHistory__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ScanHistory */ "./src/app/_models/ScanHistory.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ScanHistory", function() { return _ScanHistory__WEBPACK_IMPORTED_MODULE_2__["ScanHistory"]; });
...
class AccountService {
    ...
    login(username, password) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/login`, { username, password })
    ...
    register(user) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/addUserNow`, user);
    }
    getAll(user) {
        const formData = new FormData();
        formData.append('name', user.userName);
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/getScanHistory`, formData);
    }
    getById(id) {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/users/${id}`);
    }
    update(user) {
        return this.http.put(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/update`, user)
    ...
    upload(file, user) {
        ...
        formData.append('name', user.userName);
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/upload`, formData);
    }
}
...
/* harmony import */ var _users_add_edit_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./users/add-edit.component */ "./src/app/users/add-edit.component.ts");
...
const routes = [
    ...
    { path: 'update', component: _users_add_edit_component__WEBPACK_IMPORTED_MODULE_4__["AddEditComponent"] },
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app"]], decls: 4, vars: 4, consts: [["class", "navbar navbar-expand navbar-dark bg-dark", 4, "ngIf"], [1, "app-container", 3, "ngClass"], [1, "navbar", "navbar-expand", "navbar-dark", "bg-dark"], [1, "navbar-nav"], ["routerLink", "/", "routerLinkActive", "active", 1, "nav-item", "nav-link", 3, "routerLinkActiveOptions"], ["routerLink", "/users", "routerLinkActive", "active", 1, "nav-item", "nav-link"], ["routerLink", "/update", "routerLinkActive", "active", 1, "nav-item", "nav-link"], [1, "nav-item", "nav-link", 3, "click"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
class HomeComponent {
    constructor(accountService, http, router) {
        this.accountService = accountService;
        this.http = http;
        this.router = router;
        this.message = '';
...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["ng-component"]], decls: 25, vars: 3, consts: [[1, "p-4"], [1, "container"], ["type", "file", 1, "file-input", 3, "change"], ["fileUpload", ""], [1, "col-4"], [1, "btn", "btn-success", "btn-sm", 3, "disabled", "click"], [1, "table", "table-striped"], [2, "width", "33%"], [4, "ngIf"], ["routerLink", "/users"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function HomeComponent_Template_input_change_6_listener($event) { return ctx.onFileSelected($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HomeComponent, [{
    ...
    }], function () { return [{ type: _app_services__WEBPACK_IMPORTED_MODULE_1__["AccountService"] }, { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }]; }, null); })();
...
module.exports = __webpack_require__(/*! C:\Users\Chris\Desktop\AntivirusApplication499\src\main.ts */"./src/main.ts");
